            ...
            currentTab == t("pages.library.tabs.playlists") ?
              <Card onClick={() => {
                ...
                <div className="flex items-center">
                  <span className="w-11 h-11 rounded-full bg-gray-400 flex items-center justify-center relative flex-shrink-0
                    ...
                    <div className="flex flex-col ml-4">
                      <Title tag="h5" className="md:mb-1 max-sm:mb-1">{t("pages.library.create_playlist.title")}</Title>

        ...
        <aside 
            ...
            className={
                classNames(
                    ...
                    'max-md:fixed max-md:w-full max-md:left-0 max-md:bottom-0 max-md:pt-3 max-md:z-20 max-md:bg-[linear-gradient(180deg,rgba(255,255,255,0.82)0%,rgba(255,255,255,1)66%)] dark:max-md:bg-[linear-gradient(180deg,rgba(0,0,0,0)0%,var(--gray-700)66%)]',
